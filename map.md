...
3. [ ] Добавить тайм-аут на стороне сервера: при отсутствии трафика от клиента `SERVER_IDLE_TICKS` закрывать PTY и выходить из цикла.
4. [ ] Унифицировать логирование и диагностику через общие хелперы с форматом `param=value`.
5. [ ] Добавить runtime-assertions в основные функции и покрыть их тестами.
