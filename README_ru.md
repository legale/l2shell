# l2shell
L2-шел: клиент и сервер позволяют установить связь между хостами исключительно на уровне L2 (пользовательский EtherType `0x88B5`), IP-адреса не нужны; инструмент предназначен для аварийного доступа к устройству, когда конфигурация L3 отсутствует или повреждена.
